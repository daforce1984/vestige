...
The only tab used is the one saved in tools/.cdp_tab.json (or re-found by URL).
...
def main():
    ...
    if cmd == 'nav':
        ...
        for tt in sys.argv[3:]:
            ...
            # wait until the frozen frame has really been rendered and presented (heavy frames can take >0.5 s)
