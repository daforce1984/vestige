...
SHOTS = {
    ...
    'ion_frigate': [
        ('bridge', (0, 20, 3.5), 9, -30, 18),
        ('flank', (4.5, 22, 0.5), 9, 70, 8),
        ('stern', (0, 35, 1.5), 12, 160, 15),
        ('deck', (3, 5, 4.5), 8, 60, 35),
    ],
    'assault_frigate': [
        ('bridge', (0, 10, 7), 10, -30, 20),
        ('flank', (7, 0, 2), 12, 70, 12),
    ],
    'enemy_frigate': [
        ('flank', (6, 0, 1), 10, 70, 15),
        ('stern', (0, 26, 0), 14, 150, 20),
    ],
    'enemy_dreadnought': [
        ('prow', (40, -150, 10), 50, 60, 20),
        ('bridge', (-26, 120, 36), 30, 60, 20),
        ('stern', (0, 200, 0), 90, 150, 20),
        ('flank', (45, 0, 5), 50, 75, 12),
    ],
}
for f in ('interceptor', 'interceptor_b', 'interceptor_c', 'enemy_fighter', 'enemy_fighter_b', 'enemy_fighter_c'):
    SHOTS[f] = [('top', (0, 0.5, 0.5), 5.0, -35, 40), ('rear', (0, 2.5, 0), 5.0, 150, 20),
                ('below', (0, 0, -0.5), 5.5, -120, -30)]
SHOTS['mother_bay'] = [
